...
public class ModuleHarvestCraftCrops {
	...
	public static void init()
	{
		...
		if(Loader.isModLoaded("pamharvestcraft"))
		{
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.avocadoItem = (new IguanaFoodPam(HarvestConfigurationHandler.avocadoID, ((ItemFood)PamHarvestCraft.avocadoItem).getHealAmount(), ((ItemFood)PamHarvestCraft.avocadoItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:avocadoItem");
			} else {
				PamHarvestCraft.avocadoItem = (new IguanaFoodPam(HarvestConfigurationHandler.avocadoID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:avocadoItem");
			}
			
    		Item.itemsList[PamHarvestCraft.bananaItem.itemID] = null;
        	if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.bananaItem = (new IguanaFoodPam(HarvestConfigurationHandler.bananaID, ((ItemFood)PamHarvestCraft.bananaItem).getHealAmount(), ((ItemFood)PamHarvestCraft.bananaItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:bananaItem");
			} else {
				PamHarvestCraft.bananaItem = (new IguanaFoodPam(HarvestConfigurationHandler.bananaID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:bananaItem");
			}
	        ...
	        Item.itemsList[PamHarvestCraft.blackberryItem.itemID] = null;
	        if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.blackberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.blackberryID, ((ItemFood)PamHarvestCraft.blackberryItem).getHealAmount(), ((ItemFood)PamHarvestCraft.blackberryItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:blackberryItem");
			} else {
				PamHarvestCraft.blackberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.blackberryID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:blackberryItem");
			}
			
            Item.itemsList[PamHarvestCraft.blueberryItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.blueberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.blueberryID, ((ItemFood)PamHarvestCraft.blueberryItem).getHealAmount(), ((ItemFood)PamHarvestCraft.blueberryItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:blueberryItem");
			} else {
				PamHarvestCraft.blueberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.blueberryID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:blueberryItem");
			}
            
            Item.itemsList[PamHarvestCraft.cactusfruitItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.cactusfruitItem = (new IguanaFoodPam(HarvestConfigurationHandler.cactusfruitID, ((ItemFood)PamHarvestCraft.cactusfruitItem).getHealAmount(), ((ItemFood)PamHarvestCraft.cactusfruitItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:cactusfruitItem");
			} else {
				PamHarvestCraft.cactusfruitItem = (new IguanaFoodPam(HarvestConfigurationHandler.cactusfruitID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:cactusfruitItem");
			}
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.coconutItem = (new IguanaFoodPam(HarvestConfigurationHandler.coconutID, ((ItemFood)PamHarvestCraft.coconutItem).getHealAmount(), ((ItemFood)PamHarvestCraft.coconutItem).getSaturationModifier(), false, true, false, true)).setUnlocalizedName("PamHarvestCraft:coconutItem");
				...
				PamHarvestCraft.coconutItem = (new IguanaFoodPam(HarvestConfigurationHandler.coconutID, 1, 0.05F, false, true, false, true)).setUnlocalizedName("PamHarvestCraft:coconutItem");
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.cornItem = (new IguanaFoodPam(HarvestConfigurationHandler.cornID, ((ItemFood)PamHarvestCraft.cornItem).getHealAmount(), ((ItemFood)PamHarvestCraft.cornItem).getSaturationModifier(), false, true, false, true)).setUnlocalizedName("PamHarvestCraft:cornItem");
				...
				PamHarvestCraft.cornItem = (new IguanaFoodPam(HarvestConfigurationHandler.cornID, 1, 0.05F, false, true, false, true)).setUnlocalizedName("PamHarvestCraft:cornItem");
    		...
    		Item.itemsList[PamHarvestCraft.cranberryItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.cranberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.cranberryID, ((ItemFood)PamHarvestCraft.cranberryItem).getHealAmount(), ((ItemFood)PamHarvestCraft.cranberryItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:cranberryItem");
			} else {
				PamHarvestCraft.cranberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.cranberryID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:cranberryItem");
			}
    		...
    		if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.dragonfruitItem = (new IguanaFoodPam(HarvestConfigurationHandler.dragonfruitID, ((ItemFood)PamHarvestCraft.dragonfruitItem).getHealAmount(), ((ItemFood)PamHarvestCraft.dragonfruitItem).getSaturationModifier(), false, true, false, true)).setUnlocalizedName("PamHarvestCraft:dragonfruitItem");
			} else {
				PamHarvestCraft.dragonfruitItem = (new IguanaFoodPam(HarvestConfigurationHandler.dragonfruitID, 1, 0.05F, false, true, false, true)).setUnlocalizedName("PamHarvestCraft:dragonfruitItem");
			}
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.grapeItem = (new IguanaFoodPam(HarvestConfigurationHandler.grapeID, ((ItemFood)PamHarvestCraft.grapeItem).getHealAmount(), ((ItemFood)PamHarvestCraft.grapeItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:grapeItem");
				...
				PamHarvestCraft.grapeItem = (new IguanaFoodPam(HarvestConfigurationHandler.grapeID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:grapeItem");
    		...
    		Item.itemsList[PamHarvestCraft.kiwiItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.kiwiItem = (new IguanaFoodPam(HarvestConfigurationHandler.kiwiID, ((ItemFood)PamHarvestCraft.kiwiItem).getHealAmount(), ((ItemFood)PamHarvestCraft.kiwiItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:kiwiItem");
			} else {
				PamHarvestCraft.kiwiItem = (new IguanaFoodPam(HarvestConfigurationHandler.kiwiID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:kiwiItem");
			}
			
    		Item.itemsList[PamHarvestCraft.lemonItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.lemonItem = (new IguanaFoodPam(HarvestConfigurationHandler.lemonID, ((ItemFood)PamHarvestCraft.lemonItem).getHealAmount(), ((ItemFood)PamHarvestCraft.lemonItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:lemonItem");
			} else {
				PamHarvestCraft.lemonItem = (new IguanaFoodPam(HarvestConfigurationHandler.lemonID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:lemonItem");
			}
			
    		Item.itemsList[PamHarvestCraft.limeItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.limeItem = (new IguanaFoodPam(HarvestConfigurationHandler.limeID, ((ItemFood)PamHarvestCraft.limeItem).getHealAmount(), ((ItemFood)PamHarvestCraft.limeItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:limeItem");
			} else {
				PamHarvestCraft.limeItem = (new IguanaFoodPam(HarvestConfigurationHandler.limeID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:limeItem");
			}
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.mangoItem = (new IguanaFoodPam(HarvestConfigurationHandler.mangoID, ((ItemFood)PamHarvestCraft.mangoItem).getHealAmount(), ((ItemFood)PamHarvestCraft.mangoItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:mangoItem");
			} else {
				PamHarvestCraft.mangoItem = (new IguanaFoodPam(HarvestConfigurationHandler.mangoID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:mangoItem");
			}
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.orangeItem = (new IguanaFoodPam(HarvestConfigurationHandler.orangeID, ((ItemFood)PamHarvestCraft.orangeItem).getHealAmount(), ((ItemFood)PamHarvestCraft.orangeItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:orangeItem");
			} else {
				PamHarvestCraft.orangeItem = (new IguanaFoodPam(HarvestConfigurationHandler.orangeID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:orangeItem");
			}
			
    		Item.itemsList[PamHarvestCraft.papayaItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.papayaItem = (new IguanaFoodPam(HarvestConfigurationHandler.papayaID, ((ItemFood)PamHarvestCraft.papayaItem).getHealAmount(), ((ItemFood)PamHarvestCraft.papayaItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:papayaItem");
			} else {
				PamHarvestCraft.papayaItem = (new IguanaFoodPam(HarvestConfigurationHandler.papayaID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:papayaItem");
			}
			
    		Item.itemsList[PamHarvestCraft.peachItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.peachItem = (new IguanaFoodPam(HarvestConfigurationHandler.peachID, ((ItemFood)PamHarvestCraft.peachItem).getHealAmount(), ((ItemFood)PamHarvestCraft.peachItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:peachItem");
			} else {
				PamHarvestCraft.peachItem = (new IguanaFoodPam(HarvestConfigurationHandler.peachID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:peachItem");
			}
			
    		Item.itemsList[PamHarvestCraft.pearItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.pearItem = (new IguanaFoodPam(HarvestConfigurationHandler.pearID, ((ItemFood)PamHarvestCraft.pearItem).getHealAmount(), ((ItemFood)PamHarvestCraft.pearItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:pearItem");
			} else {
				PamHarvestCraft.pearItem = (new IguanaFoodPam(HarvestConfigurationHandler.pearID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:pearItem");
			}
			
    		Item.itemsList[PamHarvestCraft.plumItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.plumItem = (new IguanaFoodPam(HarvestConfigurationHandler.plumID, ((ItemFood)PamHarvestCraft.plumItem).getHealAmount(), ((ItemFood)PamHarvestCraft.plumItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:plumItem");
			} else {
				PamHarvestCraft.plumItem = (new IguanaFoodPam(HarvestConfigurationHandler.plumID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:plumItem");
			}
			
    		Item.itemsList[PamHarvestCraft.pomegranateItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.pomegranateItem = (new IguanaFoodPam(HarvestConfigurationHandler.pomegranateID, ((ItemFood)PamHarvestCraft.pomegranateItem).getHealAmount(), ((ItemFood)PamHarvestCraft.pomegranateItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:pomegranateItem");
			} else {
				PamHarvestCraft.pomegranateItem = (new IguanaFoodPam(HarvestConfigurationHandler.pomegranateID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:pomegranateItem");
			}
			
    		Item.itemsList[PamHarvestCraft.raspberryItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.raspberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.raspberryID, ((ItemFood)PamHarvestCraft.raspberryItem).getHealAmount(), ((ItemFood)PamHarvestCraft.raspberryItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:raspberryItem");
			} else {
				PamHarvestCraft.raspberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.raspberryID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:raspberryItem");
			}
			
    		Item.itemsList[PamHarvestCraft.riceItem.itemID] = null;
            Item.itemsList[PamHarvestCraft.ricecakeItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.riceItem = (new IguanaFoodPam(HarvestConfigurationHandler.riceID, ((ItemFood)PamHarvestCraft.riceItem).getHealAmount(), ((ItemFood)PamHarvestCraft.riceItem).getSaturationModifier(), true, false, true)).setUnlocalizedName("PamHarvestCraft:riceItem");
				...
				PamHarvestCraft.riceItem = (new IguanaFoodPam(HarvestConfigurationHandler.riceID, 1, 0.05F, true, false, true)).setUnlocalizedName("PamHarvestCraft:riceItem");
            ...
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.starfruitItem = (new IguanaFoodPam(HarvestConfigurationHandler.starfruitID, ((ItemFood)PamHarvestCraft.starfruitItem).getHealAmount(), ((ItemFood)PamHarvestCraft.starfruitItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:starfruitItem");
			} else {
				PamHarvestCraft.starfruitItem = (new IguanaFoodPam(HarvestConfigurationHandler.starfruitID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:starfruitItem");
			}
			
    		Item.itemsList[PamHarvestCraft.strawberryItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.strawberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.strawberryID, ((ItemFood)PamHarvestCraft.strawberryItem).getHealAmount(), ((ItemFood)PamHarvestCraft.strawberryItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:strawberryItem");
			} else {
				PamHarvestCraft.strawberryItem = (new IguanaFoodPam(HarvestConfigurationHandler.strawberryID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:strawberryItem");
			}
    		...
    		Item.itemsList[PamHarvestCraft.tomatoItem.itemID] = null;
            if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.tomatoItem = (new IguanaFoodPam(HarvestConfigurationHandler.tomatoID, ((ItemFood)PamHarvestCraft.tomatoItem).getHealAmount(), ((ItemFood)PamHarvestCraft.tomatoItem).getSaturationModifier(), false, true, true)).setUnlocalizedName("PamHarvestCraft:tomatoItem");
			} else {
				PamHarvestCraft.tomatoItem = (new IguanaFoodPam(HarvestConfigurationHandler.tomatoID, 1, 0.05F, false, true, true)).setUnlocalizedName("PamHarvestCraft:tomatoItem");
			}
			
			Item.itemsList[PamHarvestCraft.walnutItem.itemID] = null;
			if (IguanaConfig.modifyFoodValues == false) {
				PamHarvestCraft.walnutItem = (new IguanaFoodPam(HarvestConfigurationHandler.walnutID, ((ItemFood)PamHarvestCraft.walnutItem).getHealAmount(), ((ItemFood)PamHarvestCraft.walnutItem).getSaturationModifier(), false, true, false, true)).setUnlocalizedName("PamHarvestCraft:walnutItem");
			} else {
				PamHarvestCraft.walnutItem = (new IguanaFoodPam(HarvestConfigurationHandler.walnutID, 1, 0.05F, false, true, false, true)).setUnlocalizedName("PamHarvestCraft:walnutItem");
			}
	    	...
	    	if (Loader.isModLoaded("Thaumcraft"))
	    	{
				...
				registerAspects(PamHarvestCraft.pamappleSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamavocadoSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pambananaSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamcherrySapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamcinnamonSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamcoconutSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamdragonfruitSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamlemonSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamlimeSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pammangoSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamnutmegSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamoliveSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamorangeSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pampapayaSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pampeachSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pampearSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pampeppercornSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamplumSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pampomegranateSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamstarfruitSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamvanillabeanSapling.blockID, saplingAspects);			
				registerAspects(PamHarvestCraft.pamwalnutSapling.blockID, saplingAspects);		
	    	}
		}
	}
	...
	{
 	   if (!ThaumcraftApi.exists(id, -1))
 	   {
 		   ThaumcraftApi.registerObjectTag(id, -1, new AspectList()
 		   .add(Aspect.SEED, 1)
 		   );
 	   }
	}
