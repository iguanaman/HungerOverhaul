...
public class ModuleHarvestCraftCrops {
	...
	public static void init()
	{
		...
		if(IguanaConfig.modifyFoodValues)
		{
			...
			ItemRegistry.espressoItem = new IguanaFoodPam(HarvestConfigurationHandler.espressoID, 1, 0.0F, false, true).setPotionEffect(Potion.moveSpeed.id, 10, 1, 0.5F).setPotionEffect(Potion.jump.id, 10, 1, 0.5F).setUnlocalizedName("ItemRegistry:espressoItem");
			ItemRegistry.coffeeconlecheItem = new IguanaFoodPam(HarvestConfigurationHandler.coffeeconlecheID, 2, 0.05F, false, true).setPotionEffect(Potion.moveSpeed.id, 30, 0, 0.5F).setPotionEffect(Potion.jump.id, 30, 0, 0.5F).setUnlocalizedName("ItemRegistry:coffeeconlecheItem");
			ItemRegistry.mochaicecreamItem = new IguanaFoodPam(HarvestConfigurationHandler.mochaicecreamID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:mochaicecreamItem");
			ItemRegistry.pickledbeetsItem = new IguanaFoodPam(HarvestConfigurationHandler.pickledbeetsID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:pickledbeetsItem");
			ItemRegistry.beetsaladItem = new IguanaFoodPam(HarvestConfigurationHandler.beetsaladID, 4, 0.15F, false, true).setUnlocalizedName("ItemRegistry:beetsaladItem");
			ItemRegistry.beetsoupItem = new IguanaFoodPam(HarvestConfigurationHandler.beetsoupID, 4, 0.15F, false, true).setUnlocalizedName("ItemRegistry:beetsoupItem");
			ItemRegistry.bakedbeetsItem = new IguanaFoodPam(HarvestConfigurationHandler.bakedbeetsID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:bakedbeetsItem");
			ItemRegistry.broccolimacItem = new IguanaFoodPam(HarvestConfigurationHandler.broccolimacID, 7, 0.4F, false, true).setUnlocalizedName("ItemRegistry:broccolimacItem");
			ItemRegistry.broccolindipItem = new IguanaFoodPam(HarvestConfigurationHandler.broccolindipID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:broccolindipItem");
			ItemRegistry.creamedbroccolisoupItem = new IguanaFoodPam(HarvestConfigurationHandler.creamedbroccolisoupID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:creamedbroccolisoupItem");
			ItemRegistry.sweetpotatopieItem = new IguanaFoodPam(HarvestConfigurationHandler.sweetpotatopieID, 6, 0.35F, false, true).setUnlocalizedName("ItemRegistry:sweetpotatopieItem");
			ItemRegistry.candiedsweetpotatoesItem = new IguanaFoodPam(HarvestConfigurationHandler.candiedsweetpotatoesID, 3, 0.2F, false, true).setUnlocalizedName("ItemRegistry:candiedsweetpotatoesItem");
			ItemRegistry.mashedsweetpotatoesItem = new IguanaFoodPam(HarvestConfigurationHandler.mashedsweetpotatoesID, 3, 0.2F, false, true).setUnlocalizedName("ItemRegistry:mashedsweetpotatoesItem");
			ItemRegistry.steamedpeasItem = new IguanaFoodPam(HarvestConfigurationHandler.steamedpeasID, 3, 0.2F, false, true).setUnlocalizedName("ItemRegistry:steamedpeasItem");
			ItemRegistry.splitpeasoupItem = new IguanaFoodPam(HarvestConfigurationHandler.splitpeasoupID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:splitpeasoupItem");
			ItemRegistry.pineappleupsidedowncakeItem = new IguanaFoodPam(HarvestConfigurationHandler.pineappleupsidedowncakeID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:pineappleupsidedowncakeItem");
			ItemRegistry.pineapplehamItem = new IguanaFoodPam(HarvestConfigurationHandler.pineapplehamID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:pineapplehamItem");
			ItemRegistry.pineappleyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.pineappleyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:pineappleyogurtItem");
			ItemRegistry.turnipsoupItem = new IguanaFoodPam(HarvestConfigurationHandler.turnipsoupID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:turnipsoupItem");
			ItemRegistry.roastedrootveggiemedleyItem = new IguanaFoodPam(HarvestConfigurationHandler.roastedrootveggiemedleyID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:roastedrootveggiemedleyItem");
			ItemRegistry.bakedturnipsItem = new IguanaFoodPam(HarvestConfigurationHandler.bakedturnipsID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:bakedturnipsItem");
			ItemRegistry.gingerbreadItem = new IguanaFoodPam(HarvestConfigurationHandler.gingerbreadID, 6, 0.35F, false, true).setUnlocalizedName("ItemRegistry:gingerbreadItem");
			ItemRegistry.gingersnapsItem = new IguanaFoodPam(HarvestConfigurationHandler.gingersnapsID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:gingersnapsItem");
			ItemRegistry.candiedgingerItem = new IguanaFoodPam(HarvestConfigurationHandler.candiedgingerID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:candiedgingerItem");
			ItemRegistry.softpretzelandmustardItem = new IguanaFoodPam(HarvestConfigurationHandler.softpretzelandmustardID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:softpretzelandmustardItem");
			ItemRegistry.spicymustardporkItem = new IguanaFoodPam(HarvestConfigurationHandler.spicymustardporkID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:spicymustardporkItem");
			ItemRegistry.spicygreensItem = new IguanaFoodPam(HarvestConfigurationHandler.spicygreensID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:spicygreensItem");
			ItemRegistry.garlicbreadItem = new IguanaFoodPam(HarvestConfigurationHandler.garlicbreadID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:garlicbreadItem");
			ItemRegistry.garlicmashedpotatoesItem = new IguanaFoodPam(HarvestConfigurationHandler.garlicmashedpotatoesID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:garlicmashedpotatoesItem");
			ItemRegistry.garlicchickenItem = new IguanaFoodPam(HarvestConfigurationHandler.garlicchickenID, 7, 0.35F, false, true).setUnlocalizedName("ItemRegistry:garlicchickenItem");
			ItemRegistry.summerradishsaladItem = new IguanaFoodPam(HarvestConfigurationHandler.summerradishsaladID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:summerradishsaladItem");
			ItemRegistry.summersquashwithradishItem = new IguanaFoodPam(HarvestConfigurationHandler.summersquashwithradishID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:summersquashwithradishItem");
			ItemRegistry.celeryandpeanutbutterItem = new IguanaFoodPam(HarvestConfigurationHandler.celeryandpeanutbutterID, 3, 0.15F, false, true).setUnlocalizedName("ItemRegistry:celeryandpeanutbutterItem");
			ItemRegistry.chickencelerycasseroleItem = new IguanaFoodPam(HarvestConfigurationHandler.chickencelerycasseroleID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:chickencelerycasseroleItem");
			ItemRegistry.peasandceleryItem = new IguanaFoodPam(HarvestConfigurationHandler.peasandceleryID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:peasandceleryItem");
			ItemRegistry.celerysoupItem = new IguanaFoodPam(HarvestConfigurationHandler.celerysoupID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:celerysoupItem");
			ItemRegistry.zucchinibreadItem = new IguanaFoodPam(HarvestConfigurationHandler.zucchinibreadID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:zucchinibreadItem");
			ItemRegistry.zucchinifriesItem = new IguanaFoodPam(HarvestConfigurationHandler.zucchinifriesID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:zucchinifriesItem");
			ItemRegistry.zestyzucchiniItem = new IguanaFoodPam(HarvestConfigurationHandler.zestyzucchiniID, 9, 0.5F, false, true).setUnlocalizedName("ItemRegistry:zestyzucchiniItem");
			ItemRegistry.zucchinibakeItem = new IguanaFoodPam(HarvestConfigurationHandler.zucchinibakeID, 9, 0.5F, false, true).setUnlocalizedName("ItemRegistry:zucchinibakeItem");
			ItemRegistry.asparagusquicheItem = new IguanaFoodPam(HarvestConfigurationHandler.asparagusquicheID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:asparagusquicheItem");
			ItemRegistry.asparagussoupItem = new IguanaFoodPam(HarvestConfigurationHandler.asparagussoupID, 4, 0.15F, false, true).setUnlocalizedName("ItemRegistry:asparagussoupItem");
			ItemRegistry.walnutraisinbreadItem = new IguanaFoodPam(HarvestConfigurationHandler.walnutraisinbreadID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:walnutraisinbreadItem");
			ItemRegistry.candiedwalnutsItem = new IguanaFoodPam(HarvestConfigurationHandler.candiedwalnutsID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:candiedwalnutsItem");
			ItemRegistry.brownieItem = new IguanaFoodPam(HarvestConfigurationHandler.brownieID, 7, 0.4F, false, true).setUnlocalizedName("ItemRegistry:brownieItem");
			ItemRegistry.papayajuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.papayajuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:papayajuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.papayasmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.papayasmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:papayasmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.papayayogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.papayayogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:papayayogurtItem");
			ItemRegistry.starfruitjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.starfruitjuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:starfruitjuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.starfruitsmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.starfruitsmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:starfruitsmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.starfruityogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.starfruityogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:starfruityogurtItem");
			ItemRegistry.guacamoleItem = new IguanaFoodPam(HarvestConfigurationHandler.guacamoleID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:guacamoleItem");
			ItemRegistry.creamofavocadosoupItem = new IguanaFoodPam(HarvestConfigurationHandler.creamofavocadosoupID, 6, 0.25F, false, true).setUnlocalizedName("ItemRegistry:creamofavocadosoupItem");
			ItemRegistry.avocadoburritoItem = new IguanaFoodPam(HarvestConfigurationHandler.avocadoburritoID, 7, 0.4F, false, true).setUnlocalizedName("ItemRegistry:avocadoburritoItem");
			ItemRegistry.poachedpearItem = new IguanaFoodPam(HarvestConfigurationHandler.poachedpearID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:poachedpearItem");
			ItemRegistry.fruitcrumbleItem = new IguanaFoodPam(HarvestConfigurationHandler.fruitcrumbleID, 6, 0.35F, false, true).setUnlocalizedName("ItemRegistry:fruitcrumbleItem");
			ItemRegistry.pearyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.pearyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:pearyogurtItem");
			ItemRegistry.plumyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.plumyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:plumyogurtItem");
			ItemRegistry.bananasplitItem = new IguanaFoodPam(HarvestConfigurationHandler.bananasplitID, 7, 0.35F, false, true).setUnlocalizedName("ItemRegistry:bananasplitItem");
			ItemRegistry.banananutbreadItem = new IguanaFoodPam(HarvestConfigurationHandler.banananutbreadID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:banananutbreadItem");
			ItemRegistry.bananasmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.bananasmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:bananasmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.bananayogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.bananayogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:bananayogurtItem");
			ItemRegistry.coconutmilkItem = new IguanaFoodPam(HarvestConfigurationHandler.coconutmilkID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:coconutmilkItem").setContainerItem(Item.glassBottle);
			ItemRegistry.chickencurryItem = new IguanaFoodPam(HarvestConfigurationHandler.chickencurryID, 9, 0.5F, false, true).setUnlocalizedName("ItemRegistry:chickencurryItem");
			ItemRegistry.coconutshrimpItem = new IguanaFoodPam(HarvestConfigurationHandler.coconutshrimpID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:coconutshrimpItem");
			ItemRegistry.coconutyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.coconutyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:coconutyogurtItem");
			ItemRegistry.orangejuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.orangejuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:orangejuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.orangechickenItem = new IguanaFoodPam(HarvestConfigurationHandler.orangechickenID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:orangechickenItem");
			ItemRegistry.orangesmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.orangesmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:orangesmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.orangeyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.orangeyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:orangeyogurtItem");
			ItemRegistry.peachjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.peachjuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:peachjuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.peachcobblerItem = new IguanaFoodPam(HarvestConfigurationHandler.peachcobblerID, 6, 0.35F, false, true).setUnlocalizedName("ItemRegistry:peachcobblerItem");
			ItemRegistry.peachsmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.peachsmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:peachsmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.peachyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.peachyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:peachyogurtItem");
			ItemRegistry.limejuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.limejuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:limejuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.keylimepieItem = new IguanaFoodPam(HarvestConfigurationHandler.keylimepieID, 7, 0.4F, false, true).setUnlocalizedName("ItemRegistry:keylimepieItem");
			ItemRegistry.limesmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.limesmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:limesmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.limeyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.limeyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:limeyogurtItem");
			ItemRegistry.mangojuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.mangojuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:mangojuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.mangosmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.mangosmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:mangosmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.mangoyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.mangoyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:mangoyogurtItem");
			ItemRegistry.pomegranatejuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.pomegranatejuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:pomegranatejuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.pomegranatesmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.pomegranatesmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:pomegranatesmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.pomegranateyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.pomegranateyogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:pomegranateyogurtItem");
			ItemRegistry.vanillayogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.vanillayogurtID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:vanillayogurtItem");
			ItemRegistry.cinnamonrollItem = new IguanaFoodPam(HarvestConfigurationHandler.cinnamonrollID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:cinnamonrollItem");
			ItemRegistry.frenchtoastItem = new IguanaFoodPam(HarvestConfigurationHandler.frenchtoastID, 7, 0.4F, false, true).setUnlocalizedName("ItemRegistry:frenchtoastItem");
			ItemRegistry.marshmellowsItem = new IguanaFoodPam(HarvestConfigurationHandler.marshmellowsID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:marshmellowsItem");
			ItemRegistry.donutItem = new IguanaFoodPam(HarvestConfigurationHandler.donutID, 4, 0.25F, false, true).setUnlocalizedName("ItemRegistry:donutItem");
			ItemRegistry.chocolatedonutItem = new IguanaFoodPam(HarvestConfigurationHandler.chocolatedonutID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:chocolatedonutItem");
			ItemRegistry.powdereddonutItem = new IguanaFoodPam(HarvestConfigurationHandler.powdereddonutID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:powdereddonutItem");
			ItemRegistry.jellydonutItem = new IguanaFoodPam(HarvestConfigurationHandler.jellydonutID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:jellydonutItem");
			ItemRegistry.frosteddonutItem = new IguanaFoodPam(HarvestConfigurationHandler.frosteddonutID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:frosteddonutItem");
			ItemRegistry.cactussoupItem = new IguanaFoodPam(HarvestConfigurationHandler.cactussoupID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:cactussoupItem");
			ItemRegistry.wafflesItem = new IguanaFoodPam(HarvestConfigurationHandler.wafflesID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:wafflesItem");
			ItemRegistry.seedsoupItem = new IguanaFoodPam(HarvestConfigurationHandler.seedsoupID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:seedsoupItem");
			ItemRegistry.softpretzelItem = new IguanaFoodPam(HarvestConfigurationHandler.softpretzelID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:softpretzelItem");
			ItemRegistry.jellybeansItem = new IguanaFoodPam(HarvestConfigurationHandler.jellybeansID, 1, 0.05F, false, true).setUnlocalizedName("ItemRegistry:jellybeansItem");
			ItemRegistry.biscuitItem = new IguanaFoodPam(HarvestConfigurationHandler.biscuitID, 4, 0.25F, false, true).setUnlocalizedName("ItemRegistry:biscuitItem");
			ItemRegistry.creamcookieItem = new IguanaFoodPam(HarvestConfigurationHandler.creamcookieID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:creamcookieItem");
			ItemRegistry.jaffaItem = new IguanaFoodPam(HarvestConfigurationHandler.jaffaID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:jaffaItem");
			ItemRegistry.friedchickenItem = new IguanaFoodPam(HarvestConfigurationHandler.friedchickenID, 7, 0.35F, false, true).setUnlocalizedName("ItemRegistry:friedchickenItem");
			ItemRegistry.chocolatesprinklecakeItem = new IguanaFoodPam(HarvestConfigurationHandler.chocolatesprinklecakeID, 6, 0.35F, false, true).setUnlocalizedName("ItemRegistry:chocolatesprinklecakeItem");
			ItemRegistry.redvelvetcakeItem = new IguanaFoodPam(HarvestConfigurationHandler.redvelvetcakeID, 7, 0.35F, false, true).setUnlocalizedName("ItemRegistry:redvelvetcakeItem");
			ItemRegistry.footlongItem = new IguanaFoodPam(HarvestConfigurationHandler.footlongID, 9, 0.55F, false, true).setUnlocalizedName("ItemRegistry:footlongItem");
			ItemRegistry.blueberryyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.blueberryyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:blueberryyogurtItem");
			ItemRegistry.lemonyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.lemonyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:lemonyogurtItem");
			ItemRegistry.cherryyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.cherryyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:cherryyogurtItem");
			ItemRegistry.strawberryyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.strawberryyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:strawberryyogurtItem");
			ItemRegistry.grapeyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.grapeyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:grapeyogurtItem");
			ItemRegistry.chocolateyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.chocolateyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:chocolateyogurtItem");
			ItemRegistry.blackberryjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.blackberryjuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:blackberryjuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.blackberrycobblerItem = new IguanaFoodPam(HarvestConfigurationHandler.blackberrycobblerID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:blackberrycobblerItem");
			ItemRegistry.blackberrysmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.blackberrysmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:blackberrysmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.blackberryyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.blackberryyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:blackberryyogurtItem");
			ItemRegistry.chocolatemilkItem = new IguanaFoodPam(HarvestConfigurationHandler.chocolatemilkID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:chocolatemilkItem").setContainerItem(Item.glassBottle);
			ItemRegistry.pumpkinyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.pumpkinyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:pumpkinyogurtItem");
			ItemRegistry.raspberryjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.raspberryjuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:raspberryjuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.raspberrypieItem = new IguanaFoodPam(HarvestConfigurationHandler.raspberrypieID, 6, 0.35F, false, true).setUnlocalizedName("ItemRegistry:raspberrypieItem");
			ItemRegistry.raspberrysmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.raspberrysmoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:raspberrysmoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.raspberryyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.raspberryyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:raspberryyogurtItem");
			ItemRegistry.cinnamonsugardonutItem = new IguanaFoodPam(HarvestConfigurationHandler.cinnamonsugardonutID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:cinnamonsugardonutItem");
			ItemRegistry.melonyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.melonyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:melonyogurtItem");
			ItemRegistry.kiwijuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwijuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:kiwijuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.kiwismoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwismoothieID, 3, 0.1F, false, true).setUnlocalizedName("ItemRegistry:kiwismoothieItem").setContainerItem(Item.glassBottle);
			ItemRegistry.kiwiyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwiyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:kiwiyogurtItem");
			ItemRegistry.plainyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.plainyogurtID, 1, 0.0F, false, true).setUnlocalizedName("ItemRegistry:plainyogurtItem");
			ItemRegistry.appleyogurtItem = new IguanaFoodPam(HarvestConfigurationHandler.appleyogurtID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:appleyogurtItem");
			ItemRegistry.saltedsunflowerseedsItem = new IguanaFoodPam(HarvestConfigurationHandler.saltedsunflowerseedsID, 1, 0.05F, false, true).setUnlocalizedName("ItemRegistry:saltedsunflowerseedsItem");
			ItemRegistry.sunflowerwheatrollsItem = new IguanaFoodPam(HarvestConfigurationHandler.sunflowerwheatrollsID, 6, 0.3F, false, true).setUnlocalizedName("ItemRegistry:sunflowerwheatrollsItem");
			ItemRegistry.sunflowerbroccolisaladItem = new IguanaFoodPam(HarvestConfigurationHandler.sunflowerbroccolisaladID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:sunflowerbroccolisaladItem");
			ItemRegistry.cranberryjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.cranberryjuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:cranberryjuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.cranberrysauceItem = new IguanaFoodPam(HarvestConfigurationHandler.cranberrysauceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:cranberrysauceItem");
			ItemRegistry.cranberrybarItem = new IguanaFoodPam(HarvestConfigurationHandler.cranberrybarID, 5, 0.3F, false, true).setUnlocalizedName("ItemRegistry:cranberrybarItem");
			ItemRegistry.peppermintItem = new IguanaFoodPam(HarvestConfigurationHandler.peppermintID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:peppermintItem");
			ItemRegistry.cactusfruitjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.cactusfruitjuiceID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:cactusfruitjuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.baklavaItem = new IguanaFoodPam(HarvestConfigurationHandler.baklavaID, 7, 0.45F, false, true).setUnlocalizedName("ItemRegistry:baklavaItem");
			ItemRegistry.gummybearsItem = new IguanaFoodPam(HarvestConfigurationHandler.gummybearsID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:gummybearsItem");
			ItemRegistry.baconmushroomburgerItem = new IguanaFoodPam(HarvestConfigurationHandler.baconmushroomburgerID, 10, 0.65F, false, true).setUnlocalizedName("ItemRegistry:baconmushroomburgerItem");
			ItemRegistry.fruitpunchItem = new IguanaFoodPam(HarvestConfigurationHandler.fruitpunchID, 2, 0.05F, false, true).setUnlocalizedName("ItemRegistry:fruitpunchItem");
			ItemRegistry.meatystewItem = new IguanaFoodPam(HarvestConfigurationHandler.meatystewID, 6, 0.45F, false, true).setUnlocalizedName("ItemRegistry:meatystewItem");
			ItemRegistry.mixedsaladItem = new IguanaFoodPam(HarvestConfigurationHandler.mixedsaladID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:mixedsaladItem");
			ItemRegistry.pinacoladaItem = new IguanaFoodPam(HarvestConfigurationHandler.pinacoladaID, 2, 0.15F, false, true).setUnlocalizedName("ItemRegistry:pinacoladaItem");
			ItemRegistry.shepardspieItem = new IguanaFoodPam(HarvestConfigurationHandler.shepardspieID, 6, 0.4F, false, true).setUnlocalizedName("ItemRegistry:shepardspieItem");
			ItemRegistry.eggnogItem = new IguanaFoodPam(HarvestConfigurationHandler.eggnogID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:eggnogItem");
			ItemRegistry.custardItem = new IguanaFoodPam(HarvestConfigurationHandler.custardID, 5, 0.25F, false, true).setUnlocalizedName("ItemRegistry:custardItem");
			ItemRegistry.sushiItem = new IguanaFoodPam(HarvestConfigurationHandler.sushiID, 3, 0.2F, false, true).setUnlocalizedName("ItemRegistry:sushiItem");
			ItemRegistry.gardensoupItem = new IguanaFoodPam(HarvestConfigurationHandler.gardensoupID, 4, 0.2F, false, true).setUnlocalizedName("ItemRegistry:gardensoupItem");
			ItemRegistry.muttonrawItem = new IguanaFoodPam(HarvestConfigurationHandler.muttonrawID, 1, 0.05F, true, true).setUnlocalizedName("ItemRegistry:muttonrawItem");
			ItemRegistry.muttoncookedItem = new IguanaFoodPam(HarvestConfigurationHandler.muttoncookedID, 2, 0.1F, true, true).setUnlocalizedName("ItemRegistry:muttoncookedItem");
			ItemRegistry.calamarirawItem = new IguanaFoodPam(HarvestConfigurationHandler.calamarirawID, 1, 0.05F, false, true).setUnlocalizedName("ItemRegistry:calamarirawItem");
			ItemRegistry.calamaricookedItem = new IguanaFoodPam(HarvestConfigurationHandler.calamaricookedID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:calamaricookedItem");
			ItemRegistry.applejellyItem = new IguanaFoodPam(HarvestConfigurationHandler.applejellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:applejellyItem");
			ItemRegistry.applejellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.applejellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:applejellysandwichItem");
			ItemRegistry.blackberryjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.blackberryjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:blackberryjellyItem");
			ItemRegistry.blackberryjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.blackberryjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:blackberryjellysandwichItem");
			ItemRegistry.blueberryjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.blueberryjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:blueberryjellyItem");
			ItemRegistry.blueberryjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.blueberryjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:blueberryjellysandwichItem");
			ItemRegistry.cherryjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.cherryjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:cherryjellyItem");
			ItemRegistry.cherryjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.cherryjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:cherryjellysandwichItem");
			ItemRegistry.cranberryjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.cranberryjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:cranberryjellyItem");
			ItemRegistry.cranberryjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.cranberryjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:cranberryjellysandwichItem");
			ItemRegistry.kiwijellyItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwijellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:kiwijellyItem");
			ItemRegistry.kiwijellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwijellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:kiwijellysandwichItem");
			ItemRegistry.lemonjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.lemonjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:lemonjellyItem");
			ItemRegistry.lemonjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.lemonjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:lemonjellysandwichItem");
			ItemRegistry.limejellyItem = new IguanaFoodPam(HarvestConfigurationHandler.limejellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:limejellyItem");
			ItemRegistry.limejellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.limejellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:limejellysandwichItem");
			ItemRegistry.mangojellyItem = new IguanaFoodPam(HarvestConfigurationHandler.mangojellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:mangojellyItem");
			ItemRegistry.mangojellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.mangojellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:mangojellysandwichItem");
			ItemRegistry.orangejellyItem = new IguanaFoodPam(HarvestConfigurationHandler.orangejellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:orangejellyItem");
			ItemRegistry.orangejellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.orangejellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:orangejellysandwichItem");
			ItemRegistry.papayajellyItem = new IguanaFoodPam(HarvestConfigurationHandler.papayajellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:papayajellyItem");
			ItemRegistry.papayajellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.papayajellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:papayajellysandwichItem");
			ItemRegistry.peachjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.peachjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:peachjellyItem");
			ItemRegistry.peachjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.peachjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:peachjellysandwichItem");
			ItemRegistry.pomegranatejellyItem = new IguanaFoodPam(HarvestConfigurationHandler.pomegranatejellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:pomegranatejellyItem");
			ItemRegistry.pomegranatejellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.pomegranatejellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:pomegranatejellysandwichItem");
			ItemRegistry.raspberryjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.raspberryjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:raspberryjellyItem");
			ItemRegistry.raspberryjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.raspberryjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:raspberryjellysandwichItem");
			ItemRegistry.starfruitjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.starfruitjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:starfruitjellyItem");
			ItemRegistry.starfruitjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.starfruitjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:starfruitjellysandwichItem");
			ItemRegistry.strawberryjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.strawberryjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:strawberryjellyItem");
			ItemRegistry.strawberryjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.strawberryjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:strawberryjellysandwichItem");
			ItemRegistry.watermelonjellyItem = new IguanaFoodPam(HarvestConfigurationHandler.watermelonjellyID, 2, 0.1F, false, true).setUnlocalizedName("ItemRegistry:watermelonjellyItem");
			ItemRegistry.watermelonjellysandwichItem = new IguanaFoodPam(HarvestConfigurationHandler.watermelonjellysandwichID, 8, 0.45F, false, true).setUnlocalizedName("ItemRegistry:watermelonjellysandwichItem");
			...
			ItemRegistry.peanutbutterItem = new IguanaFoodPam(HarvestConfigurationHandler.peanutbutterID, ((ItemFood)ItemRegistry.peanutbutterItem).getHealAmount(), ((ItemFood)ItemRegistry.peanutbutterItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:peanutbutterItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.grapejellyItem = new IguanaFoodPam(HarvestConfigurationHandler.grapejellyID, ((ItemFood)ItemRegistry.grapejellyItem).getHealAmount(), ((ItemFood)ItemRegistry.grapejellyItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:grapejellyItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.lemonaideItem = new IguanaFoodPam(HarvestConfigurationHandler.lemonaideID, ((ItemFood)ItemRegistry.lemonaideItem).getHealAmount(), ((ItemFood)ItemRegistry.lemonaideItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:lemonaideItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.cherryjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.cherryjuiceID, ((ItemFood)ItemRegistry.cherryjuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.cherryjuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:cherryjuiceItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.papayajuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.papayajuiceID, ((ItemFood)ItemRegistry.papayajuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.papayajuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:papayajuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.papayasmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.papayasmoothieID, ((ItemFood)ItemRegistry.papayasmoothieItem).getHealAmount(), ((ItemFood)ItemRegistry.papayasmoothieItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:papayasmoothieItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.coconutmilkItem = new IguanaFoodPam(HarvestConfigurationHandler.coconutmilkID, ((ItemFood)ItemRegistry.coconutmilkItem).getHealAmount(), ((ItemFood)ItemRegistry.coconutmilkItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:coconutmilkItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.orangejuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.orangejuiceID, ((ItemFood)ItemRegistry.orangejuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.orangejuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:orangejuiceItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.peachjuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.peachjuiceID, ((ItemFood)ItemRegistry.peachjuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.peachjuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:peachjuiceItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.limejuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.limejuiceID, ((ItemFood)ItemRegistry.limejuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.limejuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:limejuiceItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.limesmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.limesmoothieID, ((ItemFood)ItemRegistry.limesmoothieItem).getHealAmount(), ((ItemFood)ItemRegistry.limesmoothieItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:limesmoothieItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.mangojuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.mangojuiceID, ((ItemFood)ItemRegistry.mangojuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.mangojuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:mangojuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.mangosmoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.mangosmoothieID, ((ItemFood)ItemRegistry.mangosmoothieItem).getHealAmount(), ((ItemFood)ItemRegistry.mangosmoothieItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:mangosmoothieItem").setContainerItem(Item.glassBottle);
			...
			ItemRegistry.kiwijuiceItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwijuiceID, ((ItemFood)ItemRegistry.kiwijuiceItem).getHealAmount(), ((ItemFood)ItemRegistry.kiwijuiceItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:kiwijuiceItem").setContainerItem(Item.glassBottle);
			ItemRegistry.kiwismoothieItem = new IguanaFoodPam(HarvestConfigurationHandler.kiwismoothieID, ((ItemFood)ItemRegistry.kiwismoothieItem).getHealAmount(), ((ItemFood)ItemRegistry.kiwismoothieItem).getSaturationModifier(), false, true).setUnlocalizedName("ItemRegistry:kiwismoothieItem").setContainerItem(Item.glassBottle);
