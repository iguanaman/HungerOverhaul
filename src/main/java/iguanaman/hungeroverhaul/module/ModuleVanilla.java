...
//		GameRegistry.registerBlock(cocoaNew, ItemBlock.class, null);
		...
		else
		{
			...
			Item.beef = new IguanaFood(107, 1, 0.05F, true).setUnlocalizedName("beefRaw").setTextureName("beef_raw");
			Item.beefCooked = new IguanaFood(108, 2, 0.15F, true).setUnlocalizedName("beefCooked").setTextureName("beef_cooked");
			Item.chicken = new IguanaFood(109, 1, 0.05F, true).setPotionEffect(Potion.hunger.id, 30, 0, 0.15F).setUnlocalizedName("chickenRaw").setTextureName("chicken_raw");
			Item.chickenCooked = new IguanaFood(110, 2, 0.15F, true).setUnlocalizedName("chickenCooked").setTextureName("chicken_cooked");
			Item.rotten_flesh = new IguanaFood(111, 1, 0.05F, true).setPotionEffect(Potion.hunger.id, 30, 0, 0.4F).setUnlocalizedName("rottenFlesh").setTextureName("rotten_flesh");
